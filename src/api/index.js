...
const getFundList = async (options, fromDate = new Date((new Date()).getFullYear(), 0, 1)) => {
...
const getFundData = async (cnpj, additionalFields) => {
...
const getFundStatistic = async (cnpj, benchmark, lastDaysOrFromDate, additionalFields) => {
    let fromDatePart = '';
    let rangePart = null;
...
const getFundHistory = async (cnpj, benchmark, lastDaysOrFromDate, additionalFields) => {
    let fromDatePart = '';
    let rangePart = null;
...
const getBenchmarkStatistic = async (benchmark, lastDaysOrFromDate) => {
    let fromDatePart = '';
    let rangePart = null;
...
const getBenchmarkHistory = async (benchmark, lastDaysOrFromDate) => {
    let fromDatePart = '';
    let rangePart = null;
...
const getFundIndicators = async (options, fromDate = new Date((new Date()).getFullYear(), 0, 1)) => {
...
const getEconomyIndicators = async (lastDaysOrFromDate) => {
    let fromDatePart = '';
    let rangePart = null;
...
const getFundsChanged = async (fromDate) => {
    const fundsChangedObject = await fetch(`${PROTOCOL}//${API_URL}/changed_funds?action_tstamp_stm=gte.${fromDate.toISOString()}&order=action_tstamp_stm.desc`);
...
const isInMaintenanceMode = async () => {
