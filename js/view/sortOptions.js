...
module.exports = [
    ...
    ...createOptionsFor('Sharpe 1 ano', 'iry_sharpe_1y'),
    ...createOptionsFor('Sharpe 2 ano', 'iry_sharpe_2y'),
    ...createOptionsFor('Sharpe 3 ano', 'iry_sharpe_3y'),
    ...createOptionsFor('Consistência 1 ano', 'iry_consistency_1y'),
    ...createOptionsFor('Consistência 2 ano', 'iry_consistency_2y'),
    ...createOptionsFor('Consistência 3 ano', 'iry_consistency_3y')
];